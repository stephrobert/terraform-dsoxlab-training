# Examen blanc Professional, tache 6 : HCP Terraform

Douze questions, couvrant les quatre sous-objectifs de l'objectif 6.
Repondez dans `reponses.auto.tfvars`.

| Type | Forme de la reponse |
| --- | --- |
| choix unique | une lettre, en minuscule : `b` |
| choix multiple | les lettres TRIEES et COLLEES : `ab`, jamais `ba` |

Une reponse hors format est comptee fausse : l'examen reel ne
rattrape pas davantage.
