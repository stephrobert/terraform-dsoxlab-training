# Vm Libvirt (squelette)

> **Squelette.** Ce lab n'est pas encore écrit.

Référence : [Vm Libvirt (squelette)](https://blog.stephane-robert.info/docs/infra-as-code/provisionnement/terraform/premieres-infras/vm-libvirt/)
